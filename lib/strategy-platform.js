...
function buildFallbackSnapshot() {
  return {
    ...
    narratives: {
      ...
      narrativeHeatmap: [
        { rank: 1, name: "AI & Big Data", score: 82, lifecycle: "Dominant", avgPriceChange: "+7.8%", marketCapChange: "+9.2%", volumeChange: "+18.4%" },
        { rank: 2, name: "Memes", score: 79, lifecycle: "Accelerating", avgPriceChange: "+11.4%", marketCapChange: "+15.7%", volumeChange: "+21.8%" },
      ],
      narrativeTimeline: [
    ...
    narrativeHeatmap: [
      { rank: 1, name: "AI & Big Data", score: 82, lifecycle: "Dominant", avgPriceChange: "+7.8%", marketCapChange: "+9.2%", volumeChange: "+18.4%" },
      { rank: 2, name: "Memes", score: 79, lifecycle: "Accelerating", avgPriceChange: "+11.4%", marketCapChange: "+15.7%", volumeChange: "+21.8%" },
      { rank: 3, name: "Smart Contract Platform", score: 72, lifecycle: "Dominant", avgPriceChange: "+3.1%", marketCapChange: "+4.8%", volumeChange: "+11.1%" },
    ],
    regime: {
      active: "Bull",
      summary:
